...
!(function (t, e) {
  ...
  j.on(document, 'click.bs.modal.data-api', '[data-toggle="modal"]', function (t) {
    const e = n(this);
  ...
  j.on(document, 'click.bs.offcanvas.data-api', '[data-toggle="offcanvas"]', function (t) {
    const e = n(this);
